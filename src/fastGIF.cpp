...
FastGuidedFilterMono::FastGuidedFilterMono(const cv::Mat &origI, int r, double eps, int s) : FastGuidedFilterImpl(r,
                                                                                                                  eps,
                                                                                                                  s) {
...
FastGuidedFilterColor::FastGuidedFilterColor(const cv::Mat &origI, int r, double eps, int s) : FastGuidedFilterImpl(r,
                                                                                                                    eps,
                                                                                                                    s)// : r(r), eps(eps)
{
    cv::Mat I;
